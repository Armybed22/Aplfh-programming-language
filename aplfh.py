...
class Parser:
  ...
  def if_expr_cases(self, case_keyword):
    ...
    if not self.current_tok.matches(TT_KEYWORD, 't'):
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        f"Expected 't'"
      ))
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_sin(self,exec_ctx):
    ...
    return RTResult().success(Number(math.sin(math.radians(value_int))))
  execute_sin.arg_names = ["value"]
  def execute_cos(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.cos(math.radians(value_int))))
  execute_cos.arg_names = ["value"]
  def execute_tan(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.tan(math.radians(value_int))))
  execute_tan.arg_names = ["value"]
  def execute_atan(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.atan(math.radians(value_int))))
  execute_atan.arg_names = ["value"]
  def execute_atan2(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    value_2 = (exec_ctx.symbol_table.get("value_2"))
    value_int2 = float(str(value_2))
    return RTResult().success(Number(math.atan2(math.radians(value_int),math.radians(value_int2))))
  execute_atan2.arg_names = ["value", "value_2"]
  def execute_atanh(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.atanh(math.radians(value_int))))
  execute_atanh.arg_names = ["value"]
  def execute_tanh(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.tanh(math.radians(value_int))))
  execute_tanh.arg_names = ["value"]
  def execute_sinh(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.sinh(math.radians(value_int))))
  execute_sinh.arg_names = ["value"]
  def execute_cosh(self,exec_ctx):
    value = (exec_ctx.symbol_table.get("value"))
    value_str = str(value)
    value_int = float(value_str)
    return RTResult().success(Number(math.cosh(math.radians(value_int))))
  ...
  def execute_random(self,exec_ctx):
    return RTResult().success(Number(random.uniform(0,1000000)))
  ...
  execute_swap.arg_names = ["value","value2"]
  def execute_swap_arr(self,exec_ctx):
    arr_list = exec_ctx.symbol_table.get("arr_list")
    value = int(str(exec_ctx.symbol_table.get("value")))
    value2 = int(str(exec_ctx.symbol_table.get("value2")))
...
BuiltInFunction.atan2       = BuiltInFunction("atan2")
BuiltInFunction.atanh       = BuiltInFunction("atanh")
BuiltInFunction.tanh        = BuiltInFunction("tanh")
BuiltInFunction.sinh        = BuiltInFunction("sinh")
BuiltInFunction.cosh        = BuiltInFunction("cosh")
BuiltInFunction.sqrt        = BuiltInFunction("sqrt")
BuiltInFunction.fact        = BuiltInFunction("fact") 
BuiltInFunction.str         = BuiltInFunction("str")
BuiltInFunction.int         = BuiltInFunction("int")
BuiltInFunction.float       = BuiltInFunction("float")
BuiltInFunction.idx         = BuiltInFunction("idx")
...
global_symbol_table.set("atan2", BuiltInFunction.atan2)
global_symbol_table.set("atanh", BuiltInFunction.atanh)
global_symbol_table.set("tanh", BuiltInFunction.tanh)
global_symbol_table.set("sinh", BuiltInFunction.sinh)
global_symbol_table.set("cosh", BuiltInFunction.cosh)
...
global_symbol_table.set("idx",BuiltInFunction.idx)
